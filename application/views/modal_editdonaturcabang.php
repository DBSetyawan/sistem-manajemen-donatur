            ...
            <div class="tab-content">
              <div id="tabss1" class="tab-pane fade in active">
                <div hidden="autoid1" class="form-group">
                      ...
                      <div hidden="tglmsk1" class="form-group">
                        <br>
                            <label class="control-label col-md-3">Tanggal Masuk Data</label>
                            <div class="col-md-8">
                            <input readonly name="tglmsk1" id="tglmsk1" class="form-control" type="text" hidden>
                            <span class="help-block"></span>
                            </div>
                      </div>
                      ...
                      <input readonly name="nm_kawasann1" id="nm_kawasann1" placeholder="Input Kode Kawasan Untuk Melihat Nama Kawasan" class="form-control input-sm input-sm" style="width:400px">
                          ...
                          <label class="control-label col-md-3">Petugas</label>
                            <div class="col-md-8">
                          <input readonly name="kodejgts" id="kodejgts" placeholder="Input Kode Kawasan Untuk Melihat Nama Petugas" class="form-control input-sm input-sm" style="width:400px">
                              </div>
                          </div>
                          <div class="form-group">
                       ...
                       <!--  <div class="form-group">
                            ...
                            <div class="col-md-8">
                              <input type="text" name="almktr1" id="almktr1" class="form-control input-sm" style="width:400px">
                             </select>
                    </div>
                    </div> -->
                    <div class="form-group">
                            ...
                            <div class="col-md-8">
                          <input type="text" name="alamat1" id="alamat1" class="form-control input-sm" style="width:400px">
                    </div>
                    </div>
                        <!-- <div class="form-group">
              ...
              <div id="tabss2" class="tab-pane fade">
                <br>
                    <div class="form-group">
                          ...
                          <div class="col-md-8">
                          <input name="email1" placeholder="Masukkan Email" class="form-control input-sm" type="text" style="width:400px">
                        <span class="help-block"></span>
                    </div>
                    </div>
                       <div class="form-group">
