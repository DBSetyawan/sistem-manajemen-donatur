  ...
  <div id="tab1" class="tab-pane fade in active">
    ...
    <div hidden="autoid" class="form-group">   
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="kawasann" id="kawasann" placeholder="Masukkan kode kawasan" id="autocomplete1" class="form-control input-sm autocomplete kwsn" type="search" style="width:550px">  
        </div>
        <div class="form-group">   
        <label class="col-sm-2 control-label">
          Nama Kawasan
          </label>
          <input readonly name="nm_kawasann"  placeholder="Input Kode Kawasan Untuk Melihat Nama Kawasan" id="nm_kawasann" class="form-control input-sm input-sm" type="text" style="width:550px">
        </div>
       ...
       <!--  <div class="form-group">   
        ...
        <label class="col-sm-2 control-label">
          ...
          <input readonly="jupen" name="jupen" id="jupen" placeholder="Masukkan Kode Jupen" class="form-control input-sm" type="text" style="width:550px">
        </div>
        <!--<div class="form-group">   
        <label class="col-sm-2 control-label">
          Jupen
          value="<?=$mils->kodej?>"><?=$mils->kodej . '-' . $mils->name?>
          </label>
