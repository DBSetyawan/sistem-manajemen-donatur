                ...
                <div hidden="autoid1" class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input readonly="jupen1" name="jupen1" id="jupen1" placeholder="Masukkan Kode Jupen" class="form-control input-sm" type="text" style="width:400px">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <!--<div class="form-group">
                            ...
                            <div class="col-md-8">
                               ...
                               <option disabled="jupen1" value="<?=$sd->kodej?>"><?=$sd->kodej . '-' . $sd->name?></option>
                               <?php }?>
                              </select>
                            </div>
                            </div>
