...
<div id="modalkegiatan" class="modal fade" role="dialog">
    ...
    <br />   
        ...
        <label hidden="kdacara" class="col-sm-2 control-label">
          Kode Acara
          </label>
          <input name="kdacara" id="kdacara" placeholder="Masukkan Nama Acara" class="form-control input-sm " type="text" style="width:550px">
        </div>
        <div class="form-group">   
        <label class="col-sm-2 control-label">
          Nama Acara
          </label>
          <input name="namcar" id="namcar" placeholder="Masukkan Nama Acara" class="form-control input-sm " type="text" style="width:550px">
        </div>
        <div class="form-group">   
        <label class="col-sm-2 control-label">
          Ketua Pelaksana
