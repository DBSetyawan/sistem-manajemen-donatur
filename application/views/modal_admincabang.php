...
<form action="#" id="form" name="donatur" class="form-horizontal" method="post">
  ...
  <div id="tab1" class="tab-pane fade in active">
    ...
    <div hidden="autoid" class="form-group">   
        ...
        <label class="col-sm-2 control-label">
          ...
          <input readonly name="kodejgt" id="kodejgt" placeholder="Input Kode Kawasan Untuk Melihat Nama Petugas" class="form-control input-sm input-sm" type="text" style="width:550px">
        </div>
          <!--<div class="form-group">   
        <label class="col-sm-2 control-label">
          Nama Kawasan
        ...
        <label class="col-sm-2 control-label">
          ...
          <select name="jk" placeholder="Pilih" id="jk" class="form-control input-sm" style="width:110px">
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="tempatlahir" placeholder="Masukkan Tempat Lahir" id="tempatlahir" class="form-control input-sm" type="text" style="width:550px" onkeydown="upperCaseF(this)">
        </div>
        <div class="form-group">   
        <label class="col-sm-2 control-label">
          Tanggal Lahir
          </label>
          <input name="tgllahir" id="tgllahir" placeholder="Masukkan tanggal Lahir (yyyy-mm-dd)" class="form-control input-sm datepicker" type="text" style="width:550px">
        </div>
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="alamat" id="alamat" placeholder="Masukkan Alamat Rumah" class="form-control input-sm input-sm" type="text" style="width:550px" onkeydown="upperCaseF(this)">
        </div>
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="almktr" id="almktr" placeholder="Masukkan Alamat Kantor" class="form-control input-sm input-sm" type="text" style="width:550px" required onkeydown="upperCaseF(this)">
        </div>
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="telepon" id="telepon" placeholder="Masukkan No Handphone 1" class="form-control input-sm" type="text" style="width:550px">
        </div>
         <div class="form-group">   
        <label class="col-sm-2 control-label">
          No Handphone 2
          </label>
          <input name="nohp" id="nohp" placeholder="Masukkan No Handphone 2" class="form-control input-sm" type="text" style="width:550px">
        </div>
          <div class="form-group">   
        <label class="col-sm-2 control-label">
          No Handphone 3
          </label>
          <input name="nohp3" id="nohp3" placeholder="Masukkan No Handphone 3" class="form-control input-sm" type="text" style="width:550px">
        </div>
        <div class="form-group">   
        <label class="col-sm-2 control-label">
          Telepon Kantor
          </label>
          <input name="teleponktr" id="teleponktr" placeholder="Masukkan Telepon Kantor" class="form-control input-sm" type="text" style="width:550px">
        </div>
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="faxkantor" id="faxkantor" placeholder="Masukkan Fax Kantor" class="form-control input-sm" type="text" style="width:550px">
        </div>
        <div class="form-group">   
        <label class="col-sm-2 control-label">
          Telepon Rumah
          </label>
          <input name="telprmh" id="telprmh" placeholder="Masukkan Telepon Rumah" class="form-control input-sm" type="text" style="width:550px">
        </div>
         <div class="form-group">   
        <label class="col-sm-2 control-label">
          Jupen
          ...
          <select name="jupen" id="jupen" class="form-control input-sm" style="width:550px" required>
           <?php foreach($qcab as $rew) {?>
            <option value="<?=$rew->kodej?>"><?=$rew->kodej . '-' . $rew->name?></option>
            <?php }?>
          </select>
        </div>
  </div>
  ...
  <div id="tab2" class="tab-pane fade">
       <div class="form-group">   
        <label class="col-sm-2 control-label">
          ...
          <input name="email" id="email" placeholder="Masukkan Email" class="form-control input-sm" type="text" style="width:550px">
        </div>
       ...
       <div class="form-group">   
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="rekeningdonatur" placeholder="Masukkan Rekening Donatur" class="form-control input-sm" type="text" style="width:550px">
        </div>
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="kolektif" id="kolektif" placeholder="Masukkan Kolektif" class="form-control input-sm" style="width:550px" type="text">
        </div>
         <div class="form-group">   
        <label class="col-sm-2 control-label">
          Waktu Tagih
          </label>
          <select name="waktutgh" id="waktutgh" class="form-control input-sm" style="width:550px">
          <OPTION value="">-</OPTION>
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="npwp" class="form-control input-sm" placeholder="Masukkan NPWP" type="text" style="width:550px">
        </div>
        ...
        <label class="col-sm-2 control-label">
          ...
          <select name="info" id="info" class="form-control input-sm" style="width:550px">
  ...
  <div id="tab3" class="tab-pane fade">
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="nominal" id="nominal" placeholder="Masukkan Nominal" class="form-control input-sm" maxlength="15" type="text" onkeyup="document.getElementById('format').innerHTML = formatCurrency(this.value);" style="width:550px">
          <br>
        ...
        <label class="col-sm-2 control-label">
          ...
          <input name="keterangan" id="keterangan" placeholder="Masukkan Keterangan" class="form-control input-sm" type="text" style="width:550px">
        </div>
        </div>
      </div>
      <!--TAB-->
